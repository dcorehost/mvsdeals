...
import styles from "./Nortonshop.module.css";
...
const Nortonshop = () => {
  ...
  const productsWithSale = assets.products3.map(product => {
    const onSale = [3, 4,6,12, 8,].includes(product.id); 
    return {
      ...product,
      onSale,
